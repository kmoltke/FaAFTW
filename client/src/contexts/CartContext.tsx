...
export const removeItemFromCart = (dispatch: React.Dispatch<Action>, product: Product, quantity: number, userId: number) => {
    dispatch({
        type: 'REMOVE_ITEM',
        payload: {id: product.id, price: product.price, quantity: quantity, userId: userId},
    })
}