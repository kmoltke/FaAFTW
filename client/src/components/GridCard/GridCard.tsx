...
function GridCard(props: Product) {
  ...
  const item: Product = {id: props.id, album: props.album, artist: props.artist, price: props.price, image: img}
      ...
      <>
        <div className={styles.productCard}>
          ...
          <div className={styles.productDetails}>
            <a className={styles.productTitle}>{props.album}</a>
