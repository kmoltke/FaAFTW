    ...
    try {
        ...
        if (basketIndex === -1)
            ...
            if (productIndex === -1)
                ...
                basketsArray[basketIndex].total -= (productsArray[productIndex].price/productsArray[productIndex].quantity);
                productsArray[productIndex].price -= (productsArray[productIndex].price/productsArray[productIndex].quantity);

                (productsArray[productIndex].quantity === 1) ? productsArray.splice(productIndex, 1) : productsArray[productIndex].quantity -= 1;
